...
run_invenio_cli() {
    ...
    uvx --from git+https://github.com/oarepo/invenio-cli@oarepo-feature-docker-environment invenio-cli "$@"
}
...
install_repository() {
    ...
    uv sync
    uv pip install -e ../../github.com/oarepo/oarepo-cli
    uv pip install -e ../../github.com/oarepo/invenio-cli
